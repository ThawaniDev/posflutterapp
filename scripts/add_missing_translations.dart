...
void main() {
  ...
  final missingKeys = <String, Map<String, String>>{
    ...
    'hardwareRecentEvents': {
      'en': 'Recent Events',
      'ar': 'الأحداث الأخيرة',
      'bn': 'সাম্প্রতিক ইভেন্ট',
      'ur': 'حالیہ واقعات',
    },
    ...
    'inventoryIngredientProduct': {
      'en': 'Ingredient Product',
      'ar': 'منتج المكون',
      'bn': 'উপাদান পণ্য',
      'ur': 'جزو مصنوع',
    },
    'inventoryInvalidNumber': {
      'en': 'Invalid number',
      'ar': 'رقم غير صالح',
      'bn': 'অবৈধ সংখ্যা',
      'ur': 'غلط نمبر',
    ...
    'inventoryNoMovements': {
      'en': 'No movements',
      'ar': 'لا توجد حركات',
      'bn': 'কোনো মুভমেন্ট নেই',
      'ur': 'کوئی حرکات نہیں',
    },
    'inventoryNoPOs': {
    ...
    'inventoryReferenceNumber': {
      'en': 'Reference Number',
      'ar': 'رقم المرجع',
      'bn': 'রেফারেন্স নম্বর',
      'ur': 'حوالہ نمبر',
    },
    'inventoryReferenceNumberHint': {
      'en': 'e.g. GR-001',
      'ar': 'مثال: GR-001',
      'bn': 'যেমন: GR-001',
      'ur': 'مثلاً: GR-001',
    ...
    'inventoryUnitCostLabel': {
      'en': 'Unit Cost',
      'ar': 'تكلفة الوحدة',
      'bn': 'একক খরচ',
      'ur': 'یونٹ لاگت',
    },
    'inventoryWastePercent': {
      'en': 'Waste %',
      'ar': 'نسبة الهدر %',
      'bn': 'অপচয় %',
      'ur': 'ضائعات %',
    ...
    'ordersVoided2': {
      'en': 'Order voided',
      'ar': 'تم إبطال الطلب',
      'bn': 'অর্ডার বাতিল হয়েছে',
      'ur': 'آرڈر کالعدم ہو گیا',
    },
    'ordersVoidOrder': {
      'en': 'Void Order',
      'ar': 'إبطال الطلب',
    ...
    'promotionsTotalCoupons': {
      'en': 'Total Coupons',
      'ar': 'إجمالي القسائم',
      'bn': 'মোট কুপন',
      'ur': 'کل کوپنز',
    },
    'promotionsTotalDiscount': {
      'en': 'Total Discount',
      'ar': 'إجمالي الخصم',
      'bn': 'মোট ছাড়',
      'ur': 'کل رعایت',
    ...
    'sessionsColTotalSales': {
      'en': 'Total Sales',
      'ar': 'إجمالي المبيعات',
      'bn': 'মোট বিক্রয়',
      'ur': 'کل فروخت',
    },
    'sessionsColTransactions': {
      'en': 'Transactions',
      'ar': 'المعاملات',
      'bn': 'লেনদেন',
      'ur': 'لین دین',
    ...
    'sessionsSessionPlural': {
      'en': 'sessions',
      'ar': 'جلسات',
      'bn': 'সেশন',
      'ur': 'سیشنز',
    },
    'sessionsSessionSingular': {
      'en': 'session',
      'ar': 'جلسة',
      'bn': 'সেশন',
      'ur': 'سیشن',
    },
    'sessionsStatusClosed': {
      'en': 'Closed',
      'ar': 'مغلقة',
      'bn': 'বন্ধ',
      'ur': 'بند',
    ...
    'syncUseCloud': {
      'en': 'Use Cloud',
      'ar': 'استخدام السحابة',
      'bn': 'ক্লাউড ব্যবহার করুন',
      'ur': 'کلاؤڈ استعمال کریں',
    },
    'syncUseLocal': {
      'en': 'Use Local',
      'ar': 'استخدام المحلي',
      'bn': 'স্থানীয় ব্যবহার করুন',
      'ur': 'مقامی استعمال کریں',
    },
    ...
    'termFormAddTitle': {
      'en': 'Add Terminal',
      'ar': 'إضافة طرفية',
      'bn': 'টার্মিনাল যোগ করুন',
      'ur': 'ٹرمینل شامل کریں',
    },
    'termFormCreate': {
      'en': 'Create Terminal',
      'ar': 'إنشاء طرفية',
      'bn': 'টার্মিনাল তৈরি করুন',
      'ur': 'ٹرمینل بنائیں',
    },
    'termFormCreated': {
    ...
    'terminalsColDeviceId': {
      'en': 'Device ID',
      'ar': 'معرف الجهاز',
      'bn': 'ডিভাইস আইডি',
      'ur': 'آلہ آئی ڈی',
    },
    'terminalsColLastSync': {
      'en': 'Last Sync',
      'ar': 'آخر مزامنة',
      'bn': 'সর্বশেষ সিঙ্ক',
      'ur': 'آخری مطابقت',
