...
Future<List<LabelProductSelection>?> showLabelProductPickerSheet(
        ...
        child: Column(
          children: [
            Row(
              children: [
                Expanded(
                  child: Text(l10n.labelsAddProductsToQueue, style: AppTypography.titleMedium),
                ),
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (_, i) {
                                ...
                                return CheckboxListTile(
                                  ...
                                  title: Text(p.name),
                                  subtitle: Text(
                                    '${p.sku ?? '-'}  •  ${p.sellPrice.toStringAsFixed(3)}',
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(
                      l10n.labelsSelectedCount(_selected.length),
                  ...
                  FilledButton.icon(
                    ...
                    onPressed: _selected.isEmpty
                        ? null
                        : () => Navigator.of(ctx).pop(_selected.values.toList()),
                  ),
                ],
              ),
            ),
