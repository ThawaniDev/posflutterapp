                ...
                cellBuilder: (item, colIndex, col) {
                  switch (colIndex) {
                    case 0: // Date
                      return Text(
                        item.printedAt != null
                            ? _dateFormatter.format(item.printedAt!)
                            : '—',
                      );
                    case 1: // Template
                      return Row(
                    ...
                    case 5: // Printer language
                      return item.printerLanguage != null
                          ? _LanguageBadge(language: item.printerLanguage!)
                          : const Text('—');
                    case 6: // Printed by
...
class _LanguageBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PosBadge(
      label: label,
      variant: PosBadgeVariant.custom,
      customColor: color,
      isSmall: true,
    );
  }
