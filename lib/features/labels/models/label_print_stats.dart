class LabelPrintStats {
  const LabelPrintStats({
    required this.jobsLast30Days,
    required this.productsLast30Days,
    required this.labelsLast30Days,
  });
  ...
  factory LabelPrintStats.empty() => const LabelPrintStats(
        jobsLast30Days: 0,
        productsLast30Days: 0,
        labelsLast30Days: 0,
      );
