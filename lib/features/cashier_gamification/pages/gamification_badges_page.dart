            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: [
                  ...
                  DropdownMenuItem(value: 'upsell_rate', child: Text(l10n.cgUpsellRate)),
                  DropdownMenuItem(value: 'zero_void_rate', child: Text(l10n.cgZeroVoidRate)),
                  DropdownMenuItem(value: 'consistency_king', child: Text(l10n.cgConsistency)),
                  DropdownMenuItem(value: 'early_bird', child: Text(l10n.cgEarlyBird)),
                ],
