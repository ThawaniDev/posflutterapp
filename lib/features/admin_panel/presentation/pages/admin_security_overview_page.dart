        ...
        children: [
          ...
          _QuickNavGrid(
            items: [
              ...
              _NavItem(
                label: l10n.securitySessions,
                icon: Icons.computer,
                color: AppColors.info,
                route: Routes.adminSecuritySessions,
              ),
              _NavItem(
                label: l10n.securityDevices,
                icon: Icons.phone_android,
                color: AppColors.success,
                route: Routes.adminSecurityDevices,
              ),
              _NavItem(
                label: l10n.adminIpManagement,
              ...
              _NavItem(
                label: l10n.securityAuditLogs,
                icon: Icons.history,
                color: AppColors.info,
                route: Routes.adminSecurityAuditLog,
              ),
              _NavItem(
                label: l10n.adminLoginAttempts,
                icon: Icons.login,
                color: AppColors.warning,
                route: Routes.adminSecurityLoginAttempts,
              ),
              _NavItem(
                label: l10n.adminActivityLogs,
                icon: Icons.track_changes,
                color: AppColors.purple,
                route: Routes.adminSecurityOverview,
              ),
            ],
          ),
          AppSpacing.gapH20,
