            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _infoRow('Amount', 'ر.س. ${_fmt(item['amount'])}'),
                  _infoRow('Cash Tendered', 'ر.س. ${_fmt(item['cash_tendered'])}'),
                  _infoRow('Change Given', 'ر.س. ${_fmt(item['change_given'])}'),
                  _infoRow('Tip Amount', 'ر.س. ${_fmt(item['tip_amount'])}'),
