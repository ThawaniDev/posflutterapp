            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _infoRow('Amount', 'ر.ع. ${_fmt(item['amount'])}'),
                  _infoRow('Cash Tendered', 'ر.ع. ${_fmt(item['cash_tendered'])}'),
                  _infoRow('Change Given', 'ر.ع. ${_fmt(item['change_given'])}'),
                  _infoRow('Tip Amount', 'ر.ع. ${_fmt(item['tip_amount'])}'),
