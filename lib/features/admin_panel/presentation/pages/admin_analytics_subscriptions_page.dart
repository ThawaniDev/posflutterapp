...
class _AdminAnalyticsSubscriptionsPageState extends ConsumerState<AdminAnalyticsSubscriptionsPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => ref.read(analyticsSubscriptionsProvider.notifier).load());
  }
    ...
    return Scaffold(
      ...
      body: switch (state) {
        ...
        AnalyticsSubscriptionsLoaded(
          ...
          RefreshIndicator(
            onRefresh: () => ref.read(analyticsSubscriptionsProvider.notifier).load(),
            child: ListView(
                  ...
                  ...trend.map(
                    (t) => Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text('Active: ${t['active'] ?? 0} | Trial: ${t['trial'] ?? 0} | Churned: ${t['churned'] ?? 0}'),
                      ),
                    ),
                  ),
              ],
        ...
        AnalyticsSubscriptionsError(message: final msg) => Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: AppSpacing.sm),
              ElevatedButton(
                onPressed: () => ref.read(analyticsSubscriptionsProvider.notifier).load(),
