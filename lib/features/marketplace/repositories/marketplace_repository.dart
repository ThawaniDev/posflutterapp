...
class MarketplaceRepository {
  ...
  Future<TemplatePurchase> purchase(Map<String, dynamic> data) => _apiService.purchase(data);
  ...
  Future<List<TemplateReview>> listReviews({String? listingId}) => _apiService.listReviews(listingId: listingId);
  Future<TemplateReview> createReview(Map<String, dynamic> data) => _apiService.createReview(data);
