class HeldCart {
  ...
  factory HeldCart.fromJson(Map<String, dynamic> json) {
    final rawCartData = json['cart_data'];
    final normalizedCartData = switch (rawCartData) {
      Map _ => Map<String, dynamic>.from(rawCartData),
      List _ => <String, dynamic>{'items': List<Map<String, dynamic>>.from(rawCartData)},
      _ => <String, dynamic>{},
    };
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is HeldCart && other.id == id;
  ...
  @override
  String toString() =>
      'HeldCart(id: $id, storeId: $storeId, registerId: $registerId, cashierId: $cashierId, customerId: $customerId, cartData: $cartData, ...)';
}
