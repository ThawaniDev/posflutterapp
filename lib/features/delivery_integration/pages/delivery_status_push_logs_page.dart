          ...
          children: [
            ...
            if (httpStatusCode != null)
              PosStatusBadge(
                ...
                variant: (httpStatusCode >= 200 && httpStatusCode < 300)
                    ? PosStatusBadgeVariant.success
                    : PosStatusBadgeVariant.error,
              ),
          ],
        ),
        subtitle: Row(
          children: [
            ...
            Text('${l10n.deliveryAttempt} #$attemptNumber', style: TextStyle(fontSize: 12, color: mutedColor)),
            if (pushedAt != null) ...[
              const Spacer(),
              Text(_formatDateTime(pushedAt), style: TextStyle(fontSize: 11, color: mutedColor)),
            ],
          ],
        ),
        children: [
