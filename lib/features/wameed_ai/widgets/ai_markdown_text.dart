...
MarkdownStyleSheet aiMarkdownStyle(ThemeData theme, {TextStyle? textStyle}) {
  final base =
      textStyle ?? theme.textTheme.bodyMedium?.copyWith(height: 1.5) ?? const TextStyle(height: 1.5);
  ...
  return MarkdownStyleSheet.fromTheme(theme).copyWith(
    ...
    listBullet: base,
    blockquote:
        base.copyWith(color: theme.hintColor, fontStyle: FontStyle.italic),
    blockquoteDecoration: BoxDecoration(
      color: AppColors.primary.withValues(alpha: 0.06),
      border: Border(
        left:
            BorderSide(color: AppColors.primary.withValues(alpha: 0.4), width: 3),
      ),
    ),
