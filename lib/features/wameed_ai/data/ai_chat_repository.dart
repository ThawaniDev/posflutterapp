...
class AIChatRepository {
  ...
  Future<List<AIChat>> listChats({int page = 1, int perPage = 20}) =>
      _api.listChats(page: page, perPage: perPage);

  Future<AIChat> createChat({String? llmModelId, String? title}) =>
      _api.createChat(llmModelId: llmModelId, title: title);
